...
def bigrams():
    ...
    did = []
    try:
        done = codecs.open('Bigrams_did_it.txt', 'r', 'utf-8')
        for line in done:
            line = line.strip()
            did.append(line)
        done.close()
    ...
    dic = codecs.open('Bigrams_statistics.csv', 'r', 'utf-8')
    for line in dic:
        line = line.split('^')
        h = line[0]
        ex = line[1]
    ...
    for i in d[::-1]:
        if i not in did:
            ...
            h1, h2 = i.split('|')
            print 'You have a bigram of type 1. ' + h1 + ', 2. ' + h2
            ...
            if action == 'q':
                ...
                did.append(i)
            print '\n\n'
    reg = codecs.open('Bigrams_regex_for_substitution.txt', 'a', 'utf-8')
    done = codecs.open('Bigrams_did_it.txt', 'a', 'utf-8')
    for r in regex:
        reg.write(r + '\r\n')
    for d in did:
        done.write(d + '\r\n')
